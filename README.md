...
[![Release](https://img.shields.io/github/v/release/pervasivedisplays/Pervasive_Wide_Large)](https://github.com/pervasivedisplays/Pervasive_Wide_Large/releases) [![Codacy Badge](https://app.codacy.com/project/badge/Grade/9f09780839f7479285cb931ffe4954d7)](https://app.codacy.com/gh/pervasivedisplays/Pervasive_Wide_Large/dashboard?utm_source=gh&utm_Large=referral&utm_content=&utm_campaign=Badge_grade) ![Arduino lint](https://github.com/pervasivedisplays/Pervasive_Wide_Large/actions/workflows/main.yml/badge.svg) [![GitHub issues](https://img.shields.io/github/issues/pervasivedisplays/Pervasive_Wide_Large)](https://github.com/pervasivedisplays/Pervasive_Wide_Large/issues)
...
The **Pervasive_Wide_Large** supports the screens

* Pervasive Displays iTC monochrome [with wide temperature and embedded fast update](https://www.pervasivedisplays.com/products-e-ink-display/?_sft_etc_itc=pu&_sft_temperature_range=m15c-to-p60c&_sft_product_colour=black-white) (film `K`) with sizes of 9.7" and 12"; 
